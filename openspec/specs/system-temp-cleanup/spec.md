# system-temp-cleanup Specification

## Purpose
Tier 1 catalog target that reclaims space under the per-user Darwin temporary directory by removing orphaned Chrome code-sign clones and age-gated stale temporary entries, without deleting files in use by running processes.
